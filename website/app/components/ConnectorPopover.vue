...
<template>
  <PopoverRoot>
    <PopoverTrigger as-child>
      <button class="p-1 rounded hover:bg-bg transition-colors relative">
    ...
    <PopoverPortal>
      <PopoverContent
        ...
        class="popover-content z-[100] min-w-48 p-3 rounded-lg bg-bg-elevated border border-border shadow-lg"
      >
